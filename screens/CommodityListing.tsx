...
const CommodityListing = () => {
    ...
    const takePhoto = async () => {
        ...
        if (status !== 'granted') {
            if (!canAskAgain) {
                Alert.alert('Permission Denied', 'Please enable camera permissions from your device settings.', [
                    { text: 'Cancel', style: 'cancel' },
    ...
    const pickImage = async () => {
        ...
        if (status !== 'granted') {
            if (!canAskAgain) {
                Alert.alert('Permission Denied', 'Please enable media library permissions from your device settings.', [
                    { text: 'Cancel', style: 'cancel' },
                    { text: 'Open Settings', onPress: () => Linking.openSettings() }
                ]);
            } else {
...
const styles = StyleSheet.create({
    ...
    tagContainer: { backgroundColor: '#C5E1A5', alignSelf: 'flex-start', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 4, marginBottom: 10 },
    ...
    segmentContainer: { flexDirection: 'row', backgroundColor: '#EEE', borderRadius: 8, padding: 4, marginBottom: 25 },
    ...
    dateInput: { flexDirection: 'row', justifyContent: 'space-between', backgroundColor: '#FFF', padding: 12, borderRadius: 8, alignItems: 'center', borderWidth: 1, borderColor: '#E0E0E0' },
    dateText: { color: '#777', fontWeight: '600' },
    tableCard: { backgroundColor: '#FFF', borderRadius: 12, elevation: 3, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 4, marginBottom: 20, overflow: 'hidden' },
    tableHeader: { flexDirection: 'row', backgroundColor: '#F0F0F0', padding: 12 },
    headerCell: { fontSize: 12, fontWeight: '800', color: '#888' },
    tableRow: { flexDirection: 'row', paddingVertical: 8, paddingHorizontal: 5, borderBottomWidth: 1, borderBottomColor: '#F5F5F5', alignItems: 'center' },
    pickerWrapper: { flex: 2.5, marginHorizontal: 2, borderBottomWidth: 1, borderBottomColor: '#EEE' },
    inputCell: { fontSize: 15, color: '#333', fontWeight: '500', paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: '#EEE', marginHorizontal: 4, textAlign: 'center' },
    inputCellPrice: { flex: 1, fontSize: 15, color: '#333', fontWeight: '500', paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: '#EEE', textAlign: 'center' },
    ...
    uploadBoxText: { fontSize: 10, color: '#1F5D2B', fontWeight: '700', marginTop: 4 },
    imageWrapper: { marginRight: 10, position: 'relative' },
    previewImage: { width: 80, height: 80, borderRadius: 10 },
    deleteImageBtn: { position: 'absolute', top: -5, right: -5, backgroundColor: '#FFF', borderRadius: 10 },
    ...
    cancelBtn: { alignItems: 'center', paddingBottom: 40, flexDirection: 'row', justifyContent: 'center' },
